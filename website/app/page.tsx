      ...
      <main id="main-content">
        ...
        <section className="section shell" id="results">
          <div className="section-heading" data-reveal>
            ...
            <p>
              From global appearance and scene background to precise removal and
              compositional editing. Each clip shows the source, GRNEdit, and
              representative baselines in synchronized motion.
            </p>
          </div>
        ...
        <section className="section method-section" id="method">
          <div className="shell">
            <div className="section-heading method-heading" data-reveal>
              ...
              <p>
                Binary evidence establishes where an edit remains unresolved.
                Generative refinement then develops target semantics, structure,
                and visual detail over successive steps.
              </p>
            </div>
            ...
            <div className="refinement-block" id="refinement">
              <div className="refinement-heading" data-reveal>
                ...
                <p>
                  Choose an editing type to reveal its full sampled trajectory.
                  Every prediction is aligned with the RMS Δ-Margin from the same
                  refinement step, making the progression visible at a glance.
                </p>
              </div>
        ...
        <section className="section shell qualitative-section">
          <div className="section-heading compact-heading" data-reveal>
            ...
            <p>
              Results span stylization, background replacement, local changes,
              removal, subtitle removal, and object addition.
            </p>
          </div>
